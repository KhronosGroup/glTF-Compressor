...
class ResourceLoader
{
    ...
    async loadEnvironment(environmentFile, lutFiles)
    {
     ...
     /**
     * initWebPLib must be called before encoding gltf files with WebP assets
     * @param {Object} [externalWebPLib] external ktx library (for example from a CDN)
     */
    ...
    initKtxLib(externalKtxLib)
    {
        ...
        this.view.ktxEncoder = this.view.ktxDecoder;
    }
