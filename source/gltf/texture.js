...
class gltfTexture extends GltfObject
{
    constructor(sampler = undefined, source = undefined, type = GL.TEXTURE_2D)
    {
        ...
        // GSV-KTX (non gltf)
        this.compressedGLTexture = undefined;
        this.compressedNeedUpdate = true;
    }
    ...
    destroy()
    {
        ...
        if (this.compressedGLTexture !== undefined)
        {
            // TODO: this breaks the dependency direction
            WebGl.context.deleteTexture(this.compressedGLTexture);
        }
